...
Window {
    ...
    Column{
        ...
        ListView{
            id: listview; anchors.top: tabview.bottom; anchors.bottom: parent.bottom; width: parent.width; bottomMargin: 70
            anchors.bottomMargin: 10; anchors.topMargin: 10; clip: true; spacing: 70;
            ...
            header: Rectangle{
                anchors.left: parent.left; anchors.right: parent.right; anchors.margins: 10; height: 40; z: 3; radius: 12; property alias searching: search.text
                TextInput{
                    id: search; focus: true; anchors.fill: parent; anchors.margins: 10; Text{ text: "Search Emojis"; visible: parent.text === "" ? true : false}}}
            ...
            delegate: Column{
                ...
                Flow{
                    id: flow; width: parent.width; height: childrenRect.height;
                    Repeater{
                        width: parent.width; model: modelData.emojis.filter((i) => i.description.includes(listview.headerItem.children[0].text));
                        Rectangle {width: 40; height: 40; color: '#00000000'
                            Text {anchors.centerIn: parent; text:  modelData.emoji; font.pointSize: 24; font.family: 'Apple Color Emoji';
                            }
                        }
                    }
                }
